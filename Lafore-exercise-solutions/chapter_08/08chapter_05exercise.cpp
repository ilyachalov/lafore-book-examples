...
// 08chapter_05exercise.cpp
// пополнить класс time из 3-го упражнения этой (8-й) главы перегруженными операциями
// инкремента (++) и декремента (--) в префиксной и постфиксной формах, сделать так,
// чтобы они возвращали значение
