...
// 11chapter_06exercise.cpp
// Как и в предыдущем упражнении 5 этой (11-й) главы, дана программа из упражнения 8 главы 8.
// Требуется написать функцию, округляющую денежную строку (объект класса bMoney) до долларов.
// В main ее использование должно выглядеть так: mo2 = round(mo1);. Часть суммы $0.49 или меньше
// должна округляться «вниз», а часть суммы $0.50 или больше должна округляться «вверх».
