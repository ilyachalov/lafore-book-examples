...
// 15chapter_11exercise.cpp
// Имеется текстовый файл, содержащий ряд целых чисел. Целые числа в этом файле
// отделены друг от друга пробелом. К примеру, это может быть файл, созданный
// программой из примера 722_foutiter.cpp текущей (15-й) главы. Либо такой файл
// можно создать самому в любом текстовом редакторе.
...
int main()
{
	...
	istream_iterator<int, wchar_t> is_iter(infile);        // итератор входного потока
	istream_iterator<int, wchar_t> end_of_stream;          // итератор конца входного потока
	ostream_iterator<int, wchar_t> os_iter(outfile, L" "); // итератор выходного потока

	// копируем целые числа из исходного файла в файл назначения
