...
////// Задание к упражнению 7 главы 8 //////////////////////////////////////////
...
int main()
{
	...
	do {
		wcout << L"Введите две обыкновенные дроби и знак операции (+, -, *, /) между ними,\n"
			L"(например: 1/2 + 3/4): ";
		wcin >> fr1 >> oper >> fr2;
		...
		{
		case L'+':
			fr3 = fr1 + fr2; wcout << L"Результат операции: " << fr3 << endl; break;
		case L'-':
			fr3 = fr1 - fr2; wcout << L"Результат операции: " << fr3 << endl; break;
		case L'*':
			fr3 = fr1 * fr2; wcout << L"Результат операции: " << fr3 << endl; break;
